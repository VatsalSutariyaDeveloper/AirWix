module.exports = (sequelize, DataTypes) => {
  const IndentApproval = sequelize.define("IndentApproval", {
    ...
    approve_qty: { type: DataTypes.DECIMAL(15,5), allowNull: false },
    product_base_unit: { type: DataTypes.STRING(100), allowNull: false },
    product_base_qty: { type: DataTypes.DECIMAL(15,5), allowNull: false },
    product_convert_unit: { type: DataTypes.STRING(100), allowNull: false },
    product_convert_qty: { type: DataTypes.DECIMAL(15,5), allowNull: false },
