module.exports = (sequelize, DataTypes) => {
  const InquiryTransaction = sequelize.define("InquiryTransaction", {
    ...
    quantity: { type: DataTypes.DECIMAL(15,5), allowNull: false },
    product_base_unit_id: { type: DataTypes.INTEGER, allowNull: false },
    product_base_quantity: { type: DataTypes.DECIMAL(15,5), allowNull: false },
    product_convert_unit_id: { type: DataTypes.INTEGER, allowNull: false },
    product_convert_quantity: { type: DataTypes.DECIMAL(15,5), allowNull: false },
    rate: { type: DataTypes.DECIMAL(15,5), allowNull: false },
    convert_rate: { type: DataTypes.DECIMAL(15,5), allowNull: false },
    amount: { type: DataTypes.DECIMAL(15,5), allowNull: false },
