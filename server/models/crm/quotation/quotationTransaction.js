module.exports = (sequelize, DataTypes) => {
  const QuotationTransaction = sequelize.define("QuotationTransaction", {
    ...
    product_quantity: { type: DataTypes.DECIMAL(15,5) },
    ...
    product_converted_quantity: { type: DataTypes.DECIMAL(15,5) },
    unit_wise: { type: DataTypes.STRING(50) },
    product_rate: { type: DataTypes.DECIMAL(15,5) },
    product_converted_rate: { type: DataTypes.DECIMAL(15,5) },
    discount_percentage: { type: DataTypes.DECIMAL(15,5) },
    discount_amount: { type: DataTypes.DECIMAL(15,5) },
    discount_converted_amount: { type: DataTypes.DECIMAL(15,5) },
    product_amount: { type: DataTypes.DECIMAL(15,5) },
    product_converted_amount: { type: DataTypes.DECIMAL(15,5) },
    cgst_percentage: { type: DataTypes.DECIMAL(15,5) },
    cgst_rate: { type: DataTypes.DECIMAL(15,5) },
    cgst_rate_converted: { type: DataTypes.DECIMAL(15,5) },
    sgst_percentage: { type: DataTypes.DECIMAL(15,5) },
    sgst_rate: { type: DataTypes.DECIMAL(15,5) },
    sgst_rate_converted: { type: DataTypes.DECIMAL(15,5) },
    igst_percentage: { type: DataTypes.DECIMAL(15,5) },
    igst_rate: { type: DataTypes.DECIMAL(15,5) },
    igst_rate_converted: { type: DataTypes.DECIMAL(15,5) },
    product_tax_category_id: { type: DataTypes.INTEGER },
    product_total: { type: DataTypes.DECIMAL(15,5) },
    product_converted_total: { type: DataTypes.DECIMAL(15,5) },
    budget_transaction_total: { type: DataTypes.DECIMAL(15,5) },
    budget_margin_percent: { type: DataTypes.DECIMAL(15,5) },
    budget_margin_amount: { type: DataTypes.DECIMAL(15,5) },
    budget_grand_total: { type: DataTypes.DECIMAL(15,5) },
