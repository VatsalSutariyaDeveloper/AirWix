module.exports = (sequelize, DataTypes) => {
  const Quotation = sequelize.define("Quotation", {
    ...
    net_amount: { type: DataTypes.DECIMAL(15,5) },
    net_total_converted: { type: DataTypes.DECIMAL(15,5) },
    ...
    grand_total_converted: { type: DataTypes.DECIMAL(15,5) },
    installation_type: { type: DataTypes.TINYINT, defaultValue: 0, comment: "0: No, 1: Yes" },
    paid_amount: { type: DataTypes.DECIMAL(15,5) },
    ...
    quotation_po_amount: { type: DataTypes.DECIMAL(15,5) },
