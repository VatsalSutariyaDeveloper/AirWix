  ...
  const SalesOrder = sequelize.define(
    "SalesOrder",
    {
      order_type: {
        ...
        comment: "0:Direct, 1:Multiple Quotation",
      }, // 0:Direct, 1:Multiple Quotation
      sales_order_type: {
        type: DataTypes.INTEGER,
        comment: "0:Domestic, 1:Export",
      }, // 0:Domestic, 1:Export
      ...
      grand_total: { type: DataTypes.DECIMAL(15, 5), allowNull: false },
      ...
      delivery_type: {
        ...
        defaultValue: 0,
        comment: "0 = SO Wise, 1 = Product Wise",
      },
      ...
      approval_status: { type: DataTypes.INTEGER, defaultValue: 0 },
      order_acceptance_status: { type: DataTypes.INTEGER, defaultValue: 0 },
      sales_order_status: { type: DataTypes.INTEGER, defaultValue: 0 },
