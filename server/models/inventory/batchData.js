module.exports = (sequelize, DataTypes) => {
  const BatchData = sequelize.define(
    "BatchData",
    {
      ...
      batch_qty: { type: DataTypes.DECIMAL(15,5) },
      ...
      accept_qty: { type: DataTypes.DECIMAL(15,5) },
      reject_qty: { type: DataTypes.DECIMAL(15,5) },
      reprocess_qty: { type: DataTypes.DECIMAL(15,5) },
      product_id: { type: DataTypes.INTEGER },
      batch_unit: { type: DataTypes.INTEGER },
      base_qty: { type: DataTypes.DECIMAL(15,5) },
      base_unit: { type: DataTypes.INTEGER },
      conv_qty: { type: DataTypes.DECIMAL(15,5) },
      conv_unit: { type: DataTypes.INTEGER },
      qc_qty: { type: DataTypes.DECIMAL(15,5) },
      stock_approval_status: {
        type: DataTypes.TINYINT,
        defaultValue: 0,
        comment: "0 = no, 1 = yes",
      },
      reprocess_qc: { type: DataTypes.DECIMAL(15,5) },
      ...
      extra_stock: { type: DataTypes.DECIMAL(15,5) },
      grn_accept_qty: { type: DataTypes.DECIMAL(15,5) },
      grn_reject_qty: { type: DataTypes.DECIMAL(15,5) },
      grn_reprocess_qty: { type: DataTypes.DECIMAL(15,5) },
      supplier_tc_no: { type: DataTypes.STRING(200) },
      qc_sample_qty: { type: DataTypes.DECIMAL(15,5) },
