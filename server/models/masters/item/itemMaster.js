module.exports = (sequelize, DataTypes) => {
  const ItemMaster = sequelize.define(
    "ItemMaster",
    {
      ...
      production_unit: { type: DataTypes.STRING(100), defaultValue: 0 },
      production_quantity: { type: DataTypes.DECIMAL(15,5), defaultValue: 0 },
      purchase_unit: { type: DataTypes.STRING(100), defaultValue: 0 },
      purchase_quantity: { type: DataTypes.DECIMAL(15,5), defaultValue: 0 },
      rate: { type: DataTypes.DECIMAL(15,5), defaultValue: 0 },
      description: { type: DataTypes.TEXT, allowNull: true },
      specification: { type: DataTypes.TEXT, allowNull: true },
      batch_wise_stock_manage: { type: DataTypes.INTEGER, defaultValue: 0 },
      status: {
