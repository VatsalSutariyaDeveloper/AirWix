module.exports = (sequelize, DataTypes) => {
  const ProductProcess = sequelize.define("ProductProcess", {
    ...
    process_rate: { type: DataTypes.DECIMAL(15,5) },
    ...
    process_opening: { type: DataTypes.DECIMAL(15,5) },
    process_loss: { type: DataTypes.DECIMAL(15,5) },
    process_scrap_tolerance_plus: { type: DataTypes.DECIMAL(15,5) },
    process_scrap_tolerance_minus: { type: DataTypes.DECIMAL(15,5) },
    status: {
