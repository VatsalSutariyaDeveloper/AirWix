module.exports = (sequelize, DataTypes) => {
  const taxTransaction = sequelize.define("TaxTransaction",{
      ...
      currency_rate: { type: DataTypes.DECIMAL(10, 5) },
      tax_value: { type: DataTypes.DECIMAL(12, 5), allowNull: false },
      taxable_value: { type: DataTypes.DECIMAL(12, 5) },
      taxable_value_converted: { type: DataTypes.DECIMAL(12, 5) },
      status: {
