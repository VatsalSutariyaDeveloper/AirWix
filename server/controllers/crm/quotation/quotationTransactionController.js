const { QuotationTransaction } = require("../../../models/crmModels");
...
exports.create = async (req, res) => {
  ...
  try {
    const result = await commonQuery.createRecord(QuotationTransaction, req.body);
...
exports.delete = async (req, res) => {
  try {
    const deleted = await commonQuery.softDeleteById(QuotationTransaction, req.params.id);
